      ...
      <Parallax pages={8} ref={parallaxRef}>
        ...
        >
          <div className={"flex flex-col flex-1 p-10"}>
            <h1 className={"text-4xl md:text-5xl lg:text-7xl mb-4 font-bold"}>
              Welcome, SHEC
            </h1>
        ...
        >
          <div className="flex-1 flex flex-col gap-5 md:gap-10">
            ...
            <h1
              ...
              style={{ color: page == 2 ? "rgb(255, 255, 255)" : "rgba(0, 0, 0, 0.40)" }}
            >
              Layouts
            </h1>
            <h1
              ...
              style={{ color: page == 3 ? "rgb(255, 255, 255)" : "rgba(0, 0, 0, 0.40)" }}
            >
              Buildings
            </h1>
            <h1
              ...
              style={{ color: page == 4 ? "rgb(255, 255, 255)" : "rgba(0, 0, 0, 0.40)" }}
            >
              Stadiums
            </h1>
          </div>
        ...
        >
          ...
          <div
            className={"flex flex-row items-center gap-10 mt-10 justify-center"}
          >
            <Card />
