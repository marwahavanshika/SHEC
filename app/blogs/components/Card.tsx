        ...
        <div>
            <div className="max-w-sm ">
                ...
                <div className="p-5 pl-1">
                    ...
                    <a href="#" className="blogcard inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover: focus:ring-4 focus:outline-none focus:ring-blue-300 ">
